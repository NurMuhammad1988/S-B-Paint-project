//<!-- masalan loyihada bittadanko'p canvaslar bo'lsa class  yoki id beribham ishlash mumkun -->
// GLOBAL VARIABLES
...
let ctx = canvas.getContext('2d'),//get contextni o'zini defaul idsi bo'ladi yani "2d"
	isDrawing = false,
	brushWidth = 5,
	selectedTool = 'brush',
	selectedColor = '#000',
...
const drawTriangle = e => {
	...
	ctx.lineTo(prevMouseX * 1 - e.offsetX, e.offsetY)
	ctx.closePath()
	fillColor.checked ? ctx.fill() : ctx.stroke()
}
...
saveImageBtn.addEventListener('click', () => {
	...
	link.download = `Nur-paint${Date.now()}.jpg`
